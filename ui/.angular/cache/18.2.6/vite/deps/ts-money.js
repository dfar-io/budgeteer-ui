...
// node_modules/ts-money/build/lib/currencies.js
var require_currencies = __commonJS({
  "node_modules/ts-money/build/lib/currencies.js"(exports) {
    "use strict";
...
// node_modules/ts-money/build/index.js
var require_build = __commonJS({
  "node_modules/ts-money/build/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var lodash_1 = require_lodash();
    var currencies_1 = require_currencies();
    ...
    var assertOperand = function(operand) {
      if (lodash_1.isNaN(parseFloat(operand)) && !isFinite(operand)) throw new TypeError("Operand must be a number");
    };
    var getCurrencyObject = function(currency) {
      ...
      if (currencyObj) {
        ...
        for (let key in currencies_1.Currencies) {
          if (key.toUpperCase() === currency.toUpperCase()) return currencies_1.Currencies[key];
        }
      }
    };
    ...
    var Money = class _Money {
      ...
      constructor(amount, currency) {
        if (lodash_1.isString(currency)) currency = getCurrencyObject(currency);
        if (!lodash_1.isPlainObject(currency)) throw new TypeError("Invalid currency");
      ...
      static fromInteger(amount, currency) {
        if (isAmountObject(amount)) {
          if (amount.amount === void 0 || amount.currency === void 0) throw new TypeError("Missing required parameters amount,currency");
      ...
      static fromDecimal(amount, currency, rounder) {
        ...
        if (rounder === void 0) {
          ...
          if (decimals > currency.decimal_digits) throw new Error(`The currency ${currency.code} supports only ${currency.decimal_digits} decimal digits`);
          rounder = Math.round;
        } else {
          if (["round", "floor", "ceil"].indexOf(rounder) === -1 && typeof rounder !== "function") throw new TypeError("Invalid parameter rounder");
          if (lodash_1.isString(rounder)) rounder = Math[rounder];
        }
        ...
        return new _Money(resultAmount, currency);
      }
      /**
      ...
      equals(other) {
        let self2 = this;
        assertType(other);
        return self2.amount === other.amount && self2.currency === other.currency;
      }
      /**
      ...
      add(other) {
        let self2 = this;
        assertType(other);
        assertSameCurrency(self2, other);
        return new _Money(self2.amount + other.amount, self2.currency);
      }
      /**
      ...
      multiply(multiplier, fn) {
        if (!lodash_1.isFunction(fn)) fn = Math.round;
        assertOperand(multiplier);
        let amount = fn(this.amount * multiplier);
        return new _Money(amount, this.currency);
      }
      /**
      ...
      allocate(ratios) {
        ...
        ratios.forEach(function(ratio) {
          let share = Math.floor(self2.amount * ratio / total);
          results.push(new _Money(share, self2.currency));
          remainder -= share;
        });
        for (let i = 0; remainder > 0; i++) {
          results[i] = new _Money(results[i].amount + 1, results[i].currency);
          remainder--;
        }
        return results;
      }
      ...
      compare(other) {
        ...
        assertType(other);
        assertSameCurrency(self2, other);
        if (self2.amount === other.amount) return 0;
        return self2.amount > other.amount ? 1 : -1;
      }
      /**
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=ts-money.js.map
